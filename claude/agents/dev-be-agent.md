...
1. Không hardcode: Tất cả hằng số, giá trị cấu hình, magic strings/numbers hoặc helper logic phải tách ra file Constant/Util tương ứng.
2. Tái sử dụng trước khi viết mới: Trước khi implement bất kỳ hàm nào, BẮT BUỘC kiểm tra xem util service, core library (common-lib/core-lib) đã có chức năng tương tự chưa. Tuyệt đối không viết duplicate logic đã có sẵn.
3. Logging và Xử lý lỗi nghiêm ngặt:
