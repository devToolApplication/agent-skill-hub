...
skills: system-architecture, microservice-design, api-contract-design, event-driven-architecture, security-architecture, data-architecture, integration-patterns, scalability-design, observability-design, architecture-decision-record, technical-risk-assessment, migration-planning
purpose: Universal Software Architect Agent - Thiết kế kiến trúc hệ thống, microservices, API contracts, mô hình dữ liệu và ADR.
</codex_agent_role>
